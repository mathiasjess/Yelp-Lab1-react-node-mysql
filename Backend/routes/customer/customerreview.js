...
router.get('/getcustomerreview/:id', function(req,res) {
    let returnObject = {}
    let sql3 = "SELECT restaurant.restaurantName ,review.reviewDate, review.ratings, review.comments from restaurant, review where restaurant.restaurantId = review.reviewId AND review.id = " + req.params.id + " ";
